...
console.log(document.querySelectorAll('buttons').length);
...
console.log((topics.firstChild.innerText = 'This is the first child element'));
console.log(topics);

// 25. Select the last element child of the element stored in `topics` variable (#5) and log the `typeof` the element.
console.log(typeof topics.lastChild);
